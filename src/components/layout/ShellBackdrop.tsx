  ...
  return (
    <div className="fixed inset-0 -z-10 pointer-events-none overflow-hidden" aria-hidden>
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(126,255,210,0.035) 1px, transparent 1px), linear-gradient(90deg, rgba(126,255,210,0.03) 1px, transparent 1px)',
          backgroundSize: '80px 80px',
          maskImage: 'linear-gradient(180deg, rgba(0,0,0,0.6) 0%, transparent 88%)',
        }}
      />
      {/* Mint glow — top left */}
      <div
