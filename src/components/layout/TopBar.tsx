  ...
  return (
    <header
      className={cn(
        ...
        'border-b border-[rgba(0,255,179,0.14)]',
        'bg-[linear-gradient(180deg,rgba(2,6,14,0.98),rgba(1,4,10,0.90))]',
        'backdrop-blur-xl shadow-[0_12px_36px_rgba(0,0,0,0.30)]',
      )}
    >
      {/* Mobile nav toggle */}
      <button
      ...
      <div className="flex min-w-0 flex-1 items-center gap-3 basis-0">
        <div
          className="hidden sm:flex h-8 w-8 items-center justify-center rounded-[10px] border border-[rgba(0,255,179,0.22)] bg-[rgba(0,255,179,0.08)] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]"
          aria-hidden
        >
      ...
      <div className="ml-auto flex w-full flex-wrap items-center justify-end gap-2 sm:w-auto md:gap-3 flex-shrink-0">
        ...
        <div
          ...
          className="hidden sm:grid gap-0.5 rounded-full border border-soft bg-[rgba(255,255,255,0.03)] px-3 py-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]"
        >
        ...
        <div
          className={cn(
            ...
            isOnline
              ? 'border-[rgba(0,255,179,0.22)] bg-[rgba(0,26,18,0.42)] shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_0_14px_rgba(0,255,179,0.10)]'
              : 'border-[rgba(255,170,0,0.22)] bg-[rgba(40,24,0,0.42)]',
          )}
        >
          <span
            className={cn(
              ...
              isOnline
                ? 'bg-accent-mint shadow-[0_0_8px_rgba(0,255,179,0.90)]'
                : 'bg-accent-warn shadow-[0_0_8px_rgba(255,170,0,0.80)]',
            )}
            aria-hidden
          />
          ...
          <span className={cn(
            ...
            isOnline ? 'text-[#7fffd4]' : 'text-accent-warn',
          )}>
