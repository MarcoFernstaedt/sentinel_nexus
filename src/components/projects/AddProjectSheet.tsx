...
import type { Priority, ProjectStatus } from '@/src/types/projects'
...
export function AddProjectSheet({ onClose, onAdd }: AddProjectSheetProps) {
        ...
        <form onSubmit={handleSubmit} className="grid gap-4 px-5 py-5">
          ...
          <div className="grid gap-1.5">
            ...
            <TextInput
              ...
              placeholder="e.g. Job Search Campaign, Health & Fitness, Nexus Build…"
            />
          </div>
          ...
          <div className="grid gap-1.5">
            ...
            <textarea
              ...
              placeholder="What's the goal, scope, or definition of done…"
              rows={3}
              className={cn(
